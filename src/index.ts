 ...
 */
const FNV_1A_PARAMS: Map<number, bigint[]> = new Map([
    [32, [16_777_619n, 2_166_136_261n]],
    [64, [1_099_511_628_211n, 14_695_981_039_346_656_037n]],
    [128, [309_485_009_821_345_068_724_781_371n, 144_066_263_297_769_815_596_495_629_667_062_367_629n]],
    [256, [374_144_419_156_711_147_060_143_317_175_368_453_031_918_731_002_211n, 100_029_257_958_052_580_907_070_968_620_625_704_837_092_796_014_241_193_945_225_284_501_741_471_925_557n]],
...
export default function fnv1a(data: Input, { size, outType }: Options) {
    ...
    const fnv1Params: bigint[] = FNV_1A_PARAMS.get(size) as bigint[];
    const fnv1aPrime: bigint = fnv1Params[0];
    let fnv1aOffset: bigint = fnv1Params[1];

    const isStringInput: boolean = isString(data);
    const isObjectInput: boolean = isObject(data);
    
    if (!isStringInput && !isObjectInput) {
        throw new TypeError('Only string or objects are supported as inputs');
    }

    let sData: string = (isObjectInput ? JSON.stringify(data) : data) as string;
    sData = isUnicode(sData) ? unescape(encodeURIComponent(sData)) : sData;
